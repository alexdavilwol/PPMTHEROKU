...
import com.alex.ppmtool.services.ProjectTaskService;
...
public class BacklogController {
    ...
    public ResponseEntity<?> updateProjectTask(@Valid @RequestBody ProjectTask updatedProjectTask,
        ...
        ProjectTask updatedTask = projectTaskService.updateByProjectSequence(updatedProjectTask, backlog_id,
                pt_id, principal.getName());
